/*PGR-GNU*****************************************************************
File: turnRestricted_driver.cpp
...
// CREATE OR REPLACE FUNCTION pgr_turnRestriction(edges_sql TEXT, start_vid BIGINT, end_vid BIGINT, restrictions_sql TEXT DEFAULT 'No restrictions', directed BOOLEAN DEFAULT true,
