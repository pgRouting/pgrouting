...
PGDLLEXPORT Datum _pgr_centralPointDominance(PG_FUNCTION_ARGS);
...
process(
    ...
    time_msg("processing pgr_centralPointDominance", start_t, clock());
...
PG_FUNCTION_INFO_V1(_pgr_centralPointDominance);
PGDLLEXPORT Datum _pgr_centralPointDominance(PG_FUNCTION_ARGS) {
    FuncCallContext     *funcctx;
    TupleDesc           tuple_desc;

    /**********************************************************************/
    D_rt *result_tuples = NULL;
    ...
    result_tuples = (D_rt*) funcctx->user_fctx;
    ...
    if (funcctx->call_cntr < funcctx->max_calls) {
        ...
        values[1] = Int64GetDatum(result_tuples[funcctx->call_cntr].value);
