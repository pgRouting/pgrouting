...
.. code-block:: none
    ...
    pgr_contractGraph(edges_sql, start_vid,  end_vids)
    pgr_contractGraph(edges_sql, start_vids, end_vids, directed:=true)
...
.. index:: 
    single: pgr_contractGraph(edges_sql, start_vid,  end_vids) - proposed
...
.. index:: 
    single: pgr_contractGraph(edges_sql, start_vids, end_vids, directed:=true) - proposed

.. code-block:: none

    pgr_contractGraph(  [parameters],
