//source: https://github.com/boostorg/graph_parallel/blob/master/test/named_vertices_test.cpp
...
int test_main(int argc, char** argv)
{
  ...
  std::cout<<">>>Graph vertices distribution among multiple processes(or processors):\n ";
  BGL_FORALL_VERTICES(city, map, RoadMap)
    std::cout <<"Process: "<< rank << ": " << map[city].name << ", population " 
...

  {
    ...
    std::cout<<">>>Edges distribution among multiple processes(or processors):\n ";
    BGL_FORALL_EDGES(road, map, RoadMap)
      std::cout <<"Process: "<< rank << ": " << get(city_name, source(road, map)) << " -> " 
