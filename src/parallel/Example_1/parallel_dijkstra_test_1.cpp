// Source: https://github.com/boostorg/graph_parallel/blob/master/example/dijkstra_shortest_paths.cpp
...
int main(int argc, char* argv[])
{
  ...
  const char* filename = "../Graphs/test_graph_small_2.gr";
  ...
  if (argc > 2)
    ...
    outfile.erase(outfile.begin(), outfile.begin()+i+1);
