...
BEGIN
    ...
    sseq = 0; i = 1;
    FOR result IN 
        SELECT ((row_number() over()) -1)::INTEGER, source, a.end_vid::INTEGER, agg_cost
        FROM pgr_dijkstra(new_sql, source, targets, directed) a WHERE edge = -1 ORDER BY end_vid LOOP
