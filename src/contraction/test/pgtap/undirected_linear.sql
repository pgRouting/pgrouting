...
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM pgr_contractgraph(
    ...
    ARRAY[]::integer[], ARRAY[1]::integer[], 1, false);
PREPARE v3e2q31 AS
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM ( VALUES (1, -1, 'e', 6, 10, 2, ARRAY[11]::bigint[], 1) ) AS t(seq, id, type, source, target, cost, contracted_vertices, contracted_vertices_size);
...
PREPARE v4e4q11 AS
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM ( VALUES (1, -1, 'e', 9, 11, 2, ARRAY[6]::bigint[], 1), (2, -2, 'e', 11, 12, 3, ARRAY[6, 9]::bigint[], 2) ) AS t(seq, id, type, source, target, cost, contracted_vertices, contracted_vertices_size);
...
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM pgr_contractgraph(
    'SELECT id, source, target, cost, reverse_cost FROM edge_table WHERE id = 9 or id = 11 or id = 13 or id = 15',
    ARRAY[6]::integer[], ARRAY[1]::integer[], 1, false);

PREPARE v4e4q21 AS
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM ( VALUES (1, -1, 'e', 6, 12, 2, ARRAY[9]::bigint[], 1), (2, -2, 'e', 6, 12, 2, ARRAY[11]::bigint[], 1) ) AS t(seq, id, type, source, target, cost, contracted_vertices, contracted_vertices_size);
...
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM pgr_contractgraph(
    'SELECT id, source, target, cost, reverse_cost FROM edge_table WHERE id = 9 or id = 11 or id = 13 or id = 15',
    ARRAY[6, 9]::integer[], ARRAY[1]::integer[], 1, false);
...
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM pgr_contractgraph(
    'SELECT id, source, target, cost, reverse_cost FROM edge_table WHERE id = 9 or id = 11 or id = 13 or id = 15',
    ARRAY[9, 11]::integer[], ARRAY[1]::integer[], 1, false);

PREPARE v4e4q61 AS
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM ( VALUES (1, -1, 'e', 9, 11, 2, ARRAY[6]::bigint[], 1), (2, -2, 'e', 9, 11, 2, ARRAY[12]::bigint[], 1) ) AS t(seq, id, type, source, target, cost, contracted_vertices, contracted_vertices_size);
...
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM pgr_contractgraph(
    'SELECT id, source, target, cost, reverse_cost FROM edge_table WHERE id = 9 or id = 11 or id = 13 or id = 15',
    ARRAY[6, 11]::integer[], ARRAY[1]::integer[], 1, false);

PREPARE v4e4q71 AS
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM ( VALUES (1, -1, 'e', 6, 12, 2, ARRAY[9]::bigint[], 1), (2, -2, 'e', 6, 11, 3, ARRAY[9, 12]::bigint[], 2) ) AS t(seq, id, type, source, target, cost, contracted_vertices, contracted_vertices_size);
...
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM pgr_contractgraph(
    'SELECT id, source, target, cost, reverse_cost FROM edge_table WHERE id = 9 or id = 11 or id = 13 or id = 15',
    ARRAY[6, 9, 11]::integer[], ARRAY[1]::integer[], 1, false);

PREPARE v4e4q81 AS
SELECT seq, id, type, source, target, cost, unnest(contracted_vertices) AS contracted_vertices, contracted_vertices_size FROM ( VALUES (1, -1, 'e', 9, 11, 2, ARRAY[12]::bigint[], 1) ) AS t(seq, id, type, source, target, cost, contracted_vertices, contracted_vertices_size);
