...
PREPARE v2e1q11 AS
SELECT * FROM ( VALUES (1, 2, 'v', -1, -1, '{1, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v3e2q11 AS
SELECT * FROM ( VALUES (1, 3, 'v', -1, -1, '{1, 2, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v3e2q31 AS
SELECT * FROM ( VALUES (1, 2, 'v', -1, -1, '{1, 3, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v3e2q81 AS
SELECT * FROM ( VALUES (1, 7, 'v', -1, -1, '{5, 6, }')) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v3e2q91 AS
SELECT * FROM ( VALUES (1, 5, 'v', -1, -1, '{6, 7, }')) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v4e3q11 AS
SELECT * FROM ( VALUES (1, 4, 'v', -1, -1, '{1, 2, 3, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v4e3q31 AS
SELECT * FROM ( VALUES (1, 2, 'v', -1, -1, '{1, 3, 4, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v4e3q41 AS
SELECT * FROM ( VALUES (1, 3, 'v', -1, -1, '{1, 2, 4, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v4e3q51 AS
SELECT * FROM ( VALUES (1, 8, 'v', -1, -1, '{5, 6, 7, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v4e3q61 AS
SELECT * FROM ( VALUES (1, 5, 'v', -1, -1, '{6, 7, 8, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v4e3q71 AS
SELECT * FROM ( VALUES (1, 6, 'v', -1, -1, '{5, 7, 8, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v4e3q81 AS
SELECT * FROM ( VALUES (1, 7, 'v', -1, -1, '{5, 6, 8, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v4e4q11 AS
SELECT * FROM ( VALUES (1, 5, 'v', -1, -1, '{8, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v6e4q11 AS
SELECT * FROM ( VALUES (1, 4, 'v', -1, -1, '{1, 2, 3, }'), (2, 6, 'v', -1, -1, '{5, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v6e4q21 AS
SELECT * FROM ( VALUES (1, 4, 'v', -1, -1, '{1, 2, 3, }'), (2, 5, 'v', -1, -1, '{6, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v6e4q41 AS
SELECT * FROM ( VALUES (1, 2, 'v', -1, -1, '{1, 3, 4, }'), (2, 6, 'v', -1, -1, '{5, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v6e4q51 AS
SELECT * FROM ( VALUES (1, 3, 'v', -1, -1, '{1, 2, 4, }'), (2, 6, 'v', -1, -1, '{5, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v6e4q71 AS
SELECT * FROM ( VALUES (1, 2, 'v', -1, -1, '{1, }'), (2, 3, 'v', -1, -1, '{4, }'), (3, 6, 'v', -1, -1, '{5, }') ) AS t(seq, id, type, source, target, contracted_vertices);
...
PREPARE v6e4q91 AS
SELECT * FROM ( VALUES (1, 1, 'v', -1, -1, '{2, 3, 4, }'), (2, 5, 'v', -1, -1, '{6, }') ) AS t(seq, id, type, source, target, contracted_vertices);
