...
boost::undirectedS,
Vertex, Edge > UndirectedGraph;

typedef typename boost::adjacency_list < boost::vecS, boost::vecS,
boost::bidirectionalS,
Vertex, Edge > DirectedGraph;
...
public:
     ...
     /** @name Id handling related types
       ...
       degree_to_V  | maps degree->Vids | stores V according to their degree
       degree_to_V_i| Degree iterator   | iterates over degree_to_V
       */
     //@{
