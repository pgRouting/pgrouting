...
SELECT has_function('pgr_funnydijkstra', ARRAY['text','bigint','anyarray','boolean']);
SELECT function_returns('pgr_funnydijkstra', ARRAY['text','bigint','anyarray','boolean'],'setof record');
...
SELECT set_eq('v21q01', 'v21q10','pgr_funnydijkstra 1 to many: SHOULD RETURN expected columns names & types');
