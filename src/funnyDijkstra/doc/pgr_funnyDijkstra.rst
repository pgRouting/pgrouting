...
``pgr_funnyDijkstra`` — [medium description of
...
.. code-block:: none
    ...
    pgr_funnyDijkstra(edges_sql, start_vids, end_vids, directed:=true)
...
.. index:: 
    single: pgr_funnyDijkstra(edges_sql, start_vid,  end_vids) - proposed
