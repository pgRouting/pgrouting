...
--V2.0
SELECT hasnt_function('pgr_bddijkstra', ARRAY['text','integer','integer','boolean','boolean'],'Remove old signature on version 3.0');
SELECT todo_end();

SELECT hasnt_function('pgr_bddijkstra', ARRAY['text','bigint','integer','boolean','boolean']);
SELECT hasnt_function('pgr_bddijkstra', ARRAY['text','integer','bigint','boolean','boolean']);
SELECT hasnt_function('pgr_bddijkstra', ARRAY['text','bigint','bigint','boolean','boolean']);
...
SELECT function_returns('pgr_bddijkstra', ARRAY['text','bigint','bigint','boolean'],'setof record');
SELECT function_returns('pgr_bddijkstra', ARRAY['text','bigint','anyarray','boolean'],'setof record');
SELECT function_returns('pgr_bddijkstra', ARRAY['text','anyarray','bigint','boolean'],'setof record');
SELECT function_returns('pgr_bddijkstra', ARRAY['text','anyarray','anyarray','boolean'],'setof record');
