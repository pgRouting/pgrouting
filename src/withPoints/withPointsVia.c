...
PGDLLEXPORT Datum _pgr_withpointsvia_v5(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(_pgr_withpointsvia_v5);
...
PGDLLEXPORT Datum
_pgr_withpointsvia_v5(PG_FUNCTION_ARGS) {
...
/* The 4.0 generation of pgr_withPointsVia.
 ...
 * declares. The 4.1 SQL binds to _pgr_withpointsvia_v5 instead.
 */
PGDLLEXPORT Datum
