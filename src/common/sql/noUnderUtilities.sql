...
BEGIN
    ...
    select * from _pgr_getTableName(tab, 'notice', 'pgr_getTableName') into sname,tname;
END;
$BODY$
...
BEGIN
    ...
    select * into cname from   _pgr_getColumnName(tab,col) ; --,0, 'pgr_isColumnInTable') into cname;
