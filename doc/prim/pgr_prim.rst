...
The main Characteristics are:
  ...
  - Running time: :math:`O(|connected graph| * (E*log V))`
...
**start_node** ``BIGINT``  Identifier of the starting vertex of graph.
**end_node**   ``BIGINT``  Identifier of the ending vertex. -1 for the root vertex.
