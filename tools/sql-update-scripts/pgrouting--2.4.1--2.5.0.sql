...
/*
DROP FUNCTION IF EXISTS pgr_alphashape(text,double precision);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_astarcostmatrix(text,anyarray,boolean,integer,double precision,double precision);
DROP FUNCTION IF EXISTS pgr_astarcostmatrix(text,anyarray,boolean,integer,double precision,double precision);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_astarcost(text,anyarray,anyarray,boolean,integer,double precision,double precision);
DROP FUNCTION IF EXISTS pgr_astarcost(text,anyarray,anyarray,boolean,integer,double precision,double precision);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_astarcost(text,anyarray,bigint,boolean,integer,double precision,double precision);
DROP FUNCTION IF EXISTS pgr_astarcost(text,anyarray,bigint,boolean,integer,double precision,double precision);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_astarcost(text,bigint,anyarray,boolean,integer,double precision,double precision);
DROP FUNCTION IF EXISTS pgr_astarcost(text,bigint,anyarray,boolean,integer,double precision,double precision);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_astarcost(text,bigint,bigint,boolean,integer,double precision,double precision);
DROP FUNCTION IF EXISTS pgr_astarcost(text,bigint,bigint,boolean,integer,double precision,double precision);
...
DROP FUNCTION IF EXISTS pgr_contractgraph(text,bigint[],integer,bigint[],boolean);
...
DROP FUNCTION IF EXISTS pgr_dijkstracostmatrix(text,anyarray,boolean);
DROP FUNCTION IF EXISTS pgr_dijkstracost(text,anyarray,anyarray,boolean);
DROP FUNCTION IF EXISTS pgr_dijkstracost(text,anyarray,bigint,boolean);
...
DROP FUNCTION IF EXISTS pgr_flipedges(geometry[]);
DROP FUNCTION IF EXISTS pgr_floydwarshall(text,boolean);
...
DROP FUNCTION IF EXISTS _pgr_get_statement(text);
DROP FUNCTION IF EXISTS pgr_gettablename(text);
DROP FUNCTION IF EXISTS _pgr_gettablename(text,integer,text);
DROP FUNCTION IF EXISTS pgr_gsoc_vrppdtw(text,integer,integer);
DROP FUNCTION IF EXISTS pgr_iscolumnindexed(text,text);
...
DROP FUNCTION IF EXISTS pgr_johnson(text,boolean);
...
DROP FUNCTION IF EXISTS pgr_labelgraph(text,text,text,text,text,text);
DROP FUNCTION IF EXISTS _pgr_makedistancematrix(text);
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,anyarray,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,anyarray,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,bigint,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,bigint,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,anyarray,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,anyarray,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,bigint,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,bigint,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowpushrelabel(text,anyarray,anyarray);
...
DROP FUNCTION IF EXISTS _pgr_parameter_check(text,text,boolean);
DROP FUNCTION IF EXISTS _pgr_pickdeliver(text,integer,double precision,double precision,integer);
DROP FUNCTION IF EXISTS pgr_pointsaspolygon(character varying,double precision);
DROP FUNCTION IF EXISTS pgr_pointstodmatrix(geometry[],integer);
DROP FUNCTION IF EXISTS pgr_pointstovids(geometry[],text,double precision);
DROP FUNCTION IF EXISTS pgr_pointtoedgenode(text,geometry,double precision);
...
DROP FUNCTION IF EXISTS pgr_texttopoints(text,integer);
...
DROP FUNCTION IF EXISTS _pgr_trsp(text,integer,integer,boolean,boolean,text);
...
DROP FUNCTION IF EXISTS pgr_tsp(double precision[],integer,integer);
...
DROP FUNCTION IF EXISTS _pgr_unnest_matrix(double precision[]);
...
DROP FUNCTION IF EXISTS pgr_vidstodmatrix(integer[],geometry[],text,double precision);
DROP FUNCTION IF EXISTS pgr_vidstodmatrix(text,integer[],boolean,boolean,boolean);
DROP FUNCTION IF EXISTS pgr_vrponedepot(text,text,text,integer);
