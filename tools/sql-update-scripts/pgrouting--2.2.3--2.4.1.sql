-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 2.2.3 to 2.4.1
-- generated by tools/build-extension-update-files
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -



\echo Use "ALTER extension pgrouting update to '2.4.1'" to load this file. \quit


-------------------------------------
-- remove functions no longer in the 2.4.1 extension
-------------------------------------
 ...
 */
 ...
 BEGIN
     RETURN QUERY SELECT '2.4.1'::varchar AS version, 
     					'v2.4.1'::varchar AS tag, 
                         '730891221'::varchar AS hash, 
                         'in2.4/fix-upgradescript'::varchar AS branch, 
 ...
 */
 ...
 CREATE OR REPLACE FUNCTION _pgr_dijkstra(edges_sql TEXT, start_vid BIGINT, end_vid BIGINT, directed BOOLEAN,
  ...
  '$libdir/libpgrouting-2.4', 'one_to_one_dijkstra'
 ...
 CREATE OR REPLACE FUNCTION _pgr_dijkstra(edges_sql TEXT, start_vid BIGINT, end_vids ANYARRAY, directed BOOLEAN DEFAULT true,
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'one_to_many_dijkstra'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'many_to_one_dijkstra'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'many_to_many_dijkstra'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION pgr_dijkstraVia(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'dijkstraVia'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION pgr_johnson(edges_sql TEXT, directed BOOLEAN DEFAULT TRUE,
   OUT start_vid BIGINT, OUT end_vid BIGINT, OUT agg_cost float)
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'johnson'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION pgr_floydWarshall(edges_sql TEXT, directed BOOLEAN DEFAULT TRUE, 
   OUT start_vid BIGINT, OUT end_vid BIGINT, OUT agg_cost float)
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'floydWarshall'  
     LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION _pgr_astar(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'astarOneToOne'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION _pgr_astar(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'astarOneToMany'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION _pgr_astar(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'astarManyToOne'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION _pgr_astar(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'astarManyToMany'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION pgr_withPointsDD(
     ...
     OUT agg_cost FLOAT)
   RETURNS SETOF RECORD AS
      '$libdir/libpgrouting-2.4', 'many_withPointsDD'
 ...
 CREATE OR REPLACE FUNCTION pgr_drivingDistance(
     ...
     OUT agg_cost FLOAT)
   RETURNS SETOF RECORD AS
      '$libdir/libpgrouting-2.4', 'driving_many_to_dist'
  LANGUAGE c VOLATILE STRICT;
 ...
 CREATE OR REPLACE FUNCTION _pgr_ksp(edges_sql text, start_vid bigint, end_vid bigint, k integer, directed boolean, heap_paths boolean,
   ...
   RETURNS SETOF RECORD AS
     '$libdir/libpgrouting-2.4', 'kshortest_path'
 ...
 CREATE OR REPLACE FUNCTION pgr_withPointsKSP(
   ...
   RETURNS SETOF RECORD AS
     '$libdir/libpgrouting-2.4', 'withPoints_ksp'
     LANGUAGE c STABLE STRICT;
 ...
 */
 ...
 AS '$libdir/libpgrouting-2.4', 'newTSP'
 LANGUAGE c VOLATILE STRICT;
 ...
 CREATE OR REPLACE FUNCTION pgr_eucledianTSP(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF record
 AS '$libdir/libpgrouting-2.4', 'eucledianTSP'
 LANGUAGE c VOLATILE STRICT;
 ...
 CREATE OR REPLACE FUNCTION pgr_alphashape(sql text, alpha float8 DEFAULT 0, OUT x float8, OUT y float8)
     RETURNS SETOF record
     AS '$libdir/libpgrouting-2.4', 'alphashape'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION pgr_bdAstar(
         ...
         AS '$libdir/libpgrouting-2.4', 'bidir_astar_shortest_path'
         LANGUAGE 'c' IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION _pgr_bdDijkstra(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'bdDijkstra'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 RETURNS SETOF pgr_costResult
 AS '$libdir/libpgrouting-2.4', 'turn_restrict_shortest_path_vertex'
 ...
 CREATE OR REPLACE FUNCTION _pgr_trsp(
     ...
     turn_restrict_sql text DEFAULT null)
 RETURNS SETOF pgr_costResult
 AS '$libdir/libpgrouting-2.4', 'turn_restrict_shortest_path_edge'
 LANGUAGE 'c' IMMUTABLE;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION _pgr_maxflow(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'max_flow_one_to_one'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION _pgr_maxflow(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'max_flow_one_to_many'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION _pgr_maxflow(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'max_flow_many_to_one'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION _pgr_maxflow(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'max_flow_many_to_many'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION pgr_maximumcardinalitymatching(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'maximum_cardinality_matching'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION pgr_edgeDisjointPaths(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'edge_disjoint_paths_one_to_one'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION pgr_edgeDisjointPaths(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'edge_disjoint_paths_one_to_many'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION pgr_edgeDisjointPaths(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'edge_disjoint_paths_many_to_one'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 ***********************************/
 ...
 CREATE OR REPLACE FUNCTION pgr_edgeDisjointPaths(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'edge_disjoint_paths_many_to_many'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION pgr_contractGraph(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'contractGraph'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 CREATE OR REPLACE FUNCTION _pgr_pickDeliver(
   ...
   RETURNS SETOF RECORD AS
  '$libdir/libpgrouting-2.4', 'pickDeliver'
     LANGUAGE c IMMUTABLE STRICT;
 ...
 */
 ...
 CREATE OR REPLACE FUNCTION _pgr_withPoints(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'one_to_one_withPoints'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 */
 ...
 CREATE OR REPLACE FUNCTION _pgr_withPoints(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'one_to_many_withPoints'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 */
 ...
 CREATE OR REPLACE FUNCTION _pgr_withPoints(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'many_to_one_withPoints'
 LANGUAGE c IMMUTABLE STRICT;
 ...
 */
 ...
 CREATE OR REPLACE FUNCTION _pgr_withPoints(
     ...
     OUT agg_cost FLOAT)
 RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.4', 'many_to_many_withPoints'
 LANGUAGE c IMMUTABLE STRICT;
