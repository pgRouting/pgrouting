...
pgr_astarcostmatrix(text,anyarray,boolean,integer,float,float)
pgr_astarcost(text,anyarray,anyarray,boolean,integer,float,float)
pgr_astarcost(text,anyarray,bigint,boolean,integer,float,float)
pgr_astarcost(text,bigint,anyarray,boolean,integer,float,float)
pgr_astarcost(text,bigint,bigint,boolean,integer,float,float)
_pgr_astar(text,anyarray,anyarray,boolean,integer,double precision,double precision,boolean,boolean)
pgr_astar(text,anyarray,anyarray,boolean,integer,float,float)
pgr_astar(text,anyarray,bigint,boolean,integer,float,float)
pgr_astar(text,bigint,anyarray,boolean,integer,float,float)
pgr_astar(text,bigint,bigint,boolean,integer,float,float)
