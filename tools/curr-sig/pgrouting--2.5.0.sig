...
pgr_astarcostmatrix(text,anyarray,boolean,integer,numeric,numeric)
pgr_astarcost(text,anyarray,anyarray,boolean,integer,numeric,numeric)
pgr_astarcost(text,anyarray,bigint,boolean,integer,numeric,numeric)
pgr_astarcost(text,bigint,anyarray,boolean,integer,numeric,numeric)
pgr_astarcost(text,bigint,bigint,boolean,integer,numeric,numeric)
_pgr_astar(text,anyarray,anyarray,boolean,integer,double precision,double precision,boolean,boolean)
pgr_astar(text,anyarray,anyarray,boolean,integer,numeric,numeric)
pgr_astar(text,anyarray,bigint,boolean,integer,numeric,numeric)
pgr_astar(text,bigint,anyarray,boolean,integer,numeric,numeric)
pgr_astar(text,bigint,bigint,boolean,integer,numeric,numeric)
...
_pgr_pickdelivereuclidean(text,text,integer)
_pgr_pickdeliver(text,integer,double precision,double precision,integer)
_pgr_pickdeliver(text,text,text,integer)
