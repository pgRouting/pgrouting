...
_pgr_bdastar(text,anyarray,anyarray,boolean ,integer ,float ,float ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float)
...
_pgr_dijkstra(text,anyarray,anyarray,boolean ,boolean ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float)
...
pgr_bdastarcostmatrix(text,anyarray,boolean ,integer ,numeric ,numeric ,out bigint,out bigint,out float)
