...
_pgr_astar(text,bigint,anyarray,boolean ,integer ,float ,float ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float)
_pgr_astar(text,anyarray,bigint,boolean ,integer ,float ,float ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float)
_pgr_astar(text,anyarray,anyarray,boolean ,integer ,float ,float ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float)
_pgr_bdastar(text,bigint,bigint,boolean ,integer ,float ,float ,boolean ,out integer,out integer,out bigint,out bigint,out float,out float)
_pgr_bddijkstra(text,bigint,bigint,boolean,boolean ,out integer,out integer,out bigint,out bigint,out float,out float)
...
_pgr_maxflow(text,bigint,bigint,integer ,boolean ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint )
_pgr_maxflow(text,bigint,anyarray,integer ,boolean ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint )
_pgr_maxflow(text,anyarray,bigint,integer ,boolean ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint )
_pgr_maxflow(text,anyarray,anyarray,integer ,boolean ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint )
...
_pgr_unnest_matrix(float8[][],out integer,out integer,out float8)
...
pgr_astar(text,bigint,anyarray,boolean ,integer ,float ,float ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float)
pgr_astar(text,anyarray,bigint,boolean ,integer ,float ,float ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float)
pgr_astar(text,anyarray,anyarray,boolean ,integer ,float ,float ,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float)
pgr_astar(text,integer,integer,boolean,boolean)
pgr_astarcost(text,bigint,anyarray,boolean ,integer ,float ,float ,out bigint,out bigint,out float)
pgr_astarcost(text,bigint,bigint,boolean ,integer ,float ,float ,out bigint,out bigint,out float)
pgr_astarcost(text,anyarray,bigint,boolean ,integer ,float ,float ,out bigint,out bigint,out float)
pgr_astarcost(text,anyarray,anyarray,boolean ,integer ,float ,float ,out bigint,out bigint,out float)
pgr_astarcostmatrix(text,anyarray,boolean ,integer ,float ,float ,out bigint,out bigint,out float)
pgr_bdastar(text,bigint,bigint,out integer,out integer,out bigint,out bigint,out float,out float)
pgr_bdastar(text,bigint,bigint,boolean,integer ,float ,float ,out integer,out integer,out bigint,out bigint,out float,out float)
pgr_bdastar(text,integer,integer,boolean,boolean)
pgr_bddijkstra(text,bigint,bigint,out integer,out integer,out bigint,out bigint,out float,out float)
pgr_bddijkstra(text,bigint,bigint,boolean,out integer,out integer,out bigint,out bigint,out float,out float)
