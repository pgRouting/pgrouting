...
_pgr_maxflow(text,bigint,bigint,text ,boolean ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint )
_pgr_maxflow(text,bigint,anyarray,text ,boolean ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint )
_pgr_maxflow(text,anyarray,bigint,text ,boolean ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint )
_pgr_maxflow(text,anyarray,anyarray,text ,boolean ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint )
