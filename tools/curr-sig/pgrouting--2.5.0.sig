...
#FUNCTIONS
_pgr_astar(text,anyarray,anyarray,boolean ,integer ,float ,float ,boolean ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float)
...
_pgr_pickdelivereuclidean(text,text,integer ,integer ,out integer,out integer,out bigint,out integer,out bigint,out int,out float,out float,out float,out float,out float,out float )
...
pgr_astar(text,bigint,bigint,boolean ,integer ,numeric ,numeric ,out integer,out integer,out bigint,out bigint,out float,out float)
