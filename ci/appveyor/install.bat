...
endlocal & set PATH=%PATH%& set BOOST_THREAD_LIB=%BOOST_THREAD_LIB%& set BOOST_SYSTEM_LIB=%BOOST_SYSTEM_LIB%& set BOOST_INCLUDE_DIR=%BOOST_INCLUDE_DIR%& GMP_LIBRARIES=%GMP_LIBRARIES%& set MPFR_LIBRARIES=%MPFR_LIBRARIES%& set CGAL_LIBRARIES=%CGAL_LIBRARIES%& set CGAL_INCLUDE_DIR=%CGAL_INCLUDE_DIR%& set CMAKE_GENERATOR=%CMAKE_GENERATOR%&
