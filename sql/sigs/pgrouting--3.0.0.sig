...
_pgr_boyermyrvold(text,anyarray,bigint,boolean)
pgr_boyermyrvold(text,anyarray,bigint,boolean)
pgr_boyermyrvold(text,bigint,bigint,boolean)
...
_pgr_kargerscontraction(text)
pgr_kargerscontraction(text)
