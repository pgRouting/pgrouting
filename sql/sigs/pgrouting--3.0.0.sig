...
pgr_kruskalbfs(text,anyarray,integer)
pgr_kruskalbfs(text,bigint,integer)
pgr_kruskaldd(text,anyarray,double precision)
pgr_kruskaldd(text,bigint,double precision)
pgr_kruskaldfs(text,anyarray,integer)
pgr_kruskaldfs(text,bigint,integer)
pgr_kruskal(text)
_pgr_kruskal(text,anyarray,text,integer,double precision)
