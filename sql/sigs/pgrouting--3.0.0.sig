...
pgr_kargerscontraction(text,anyarray,bigint)
_pgr_kargerscontraction(text,anyarray,text,bigint,double precision)
pgr_kargerscontraction(text,bigint,bigint)
