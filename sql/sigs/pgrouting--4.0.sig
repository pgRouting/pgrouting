...
_pgr_trsp(text,text,text,boolean)
...
_pgr_trsp_withpoints(text,text,text,anyarray,anyarray,boolean,character,boolean,boolean,boolean)
...
_pgr_trsp_withpoints(text,text,text,text,boolean,character,boolean,boolean)
_pgr_trsp_withpointsvia(text,text,text,anyarray,boolean,boolean,boolean,boolean,character)
pgr_trsp_withpointsvia(text,text,text,anyarray,boolean,boolean,boolean,boolean,character)
...
_pgr_withpointsvia(text,text,anyarray,boolean,boolean,boolean,boolean,character)
pgr_withpointsvia(text,text,anyarray,boolean,boolean,boolean,boolean,character)
