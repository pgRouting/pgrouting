...
_pgr_withpointstrsp(text,integer,double precision,integer,double precision,boolean,text)
pgr_withpointstrsp(text,integer,double precision,integer,double precision,boolean,text)
