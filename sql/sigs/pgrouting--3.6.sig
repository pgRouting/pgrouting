...
_pgr_kspv4(text,anyarray,anyarray,integer,boolean,boolean)
_pgr_kspv4(text,text,integer,boolean,boolean)
...
_pgr_withpointskspv4(text,text,anyarray,anyarray,integer,character,boolean,boolean,boolean)
_pgr_withpointskspv4(text,text,text,integer,character,boolean,boolean,boolean)
