...
SELECT is_empty('v3e2q20', 'graph_e_1_2 QUERY 1: Directed graph with two edges and 2 is forbidden vertex');
...
PREPARE v4e3q11 AS
SELECT * FROM (VALUES
    (1, 'e', -1, ARRAY[3]::bigint[], 4, 6, 2),
    (2, 'e', -2, ARRAY[3, 6]::bigint[], 4, 11, 3))
AS t(seq, type, id, contracted_vertices, source, target, cost);
...
PREPARE v4e4q11 AS
SELECT * FROM (VALUES
    (1, 'e', -1, ARRAY[6]::bigint[], 9, 11, 2),
    (2, 'e', -2, ARRAY[6, 9]::bigint[], 12, 11, 3))
AS t(seq, type, id, contracted_vertices, source, target, cost);
...
PREPARE v4e4q21 AS
SELECT * FROM (VALUES
    (1, 'e', -1, ARRAY[9]::bigint[], 6, 12, 2),
    (2, 'e', -2, ARRAY[9]::bigint[], 12, 6, 2),
    (3, 'e', -3, ARRAY[11]::bigint[], 6, 12, 2))
AS t(seq, type, id, contracted_vertices, source, target, cost);
...
SELECT * FROM (VALUES
    (1, 'e', -1, ARRAY[6]::bigint[], 9, 11, 2),
    (2, 'e', -2, ARRAY[6, 11]::bigint[], 9, 12, 3))
AS t(seq, type, id, contracted_vertices, source, target, cost);
...
PREPARE v4e4q51 AS
SELECT * FROM (VALUES
    (1, 'e', -1, ARRAY[11]::bigint[], 6, 12, 2),
    (2, 'e', -2, ARRAY[11, 12]::bigint[], 6, 9, 3))
AS t(seq, type, id, contracted_vertices, source, target, cost);
...
SELECT * FROM (VALUES
    (1, 'e', -1, ARRAY[9]::bigint[], 6, 12, 2),
    (2, 'e', -2, ARRAY[9]::bigint[], 12, 6, 2),
    (3, 'e', -3, ARRAY[9, 12]::bigint[], 11, 6, 3))
AS t(seq, type, id, contracted_vertices, source, target, cost);
