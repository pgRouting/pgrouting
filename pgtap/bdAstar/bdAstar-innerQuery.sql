...
SELECT has_function('pgr_bdastar', ARRAY['text', 'text', 'boolean', 'integer', 'numeric', 'numeric']);
...
SELECT function_returns('pgr_bdastar', ARRAY['text', 'anyarray', 'anyarray', 'boolean', 'integer', 'numeric', 'numeric'],
    'setof record');
SELECT function_returns('pgr_bdastar', ARRAY['text', 'text', 'boolean', 'integer', 'numeric', 'numeric'],
    'setof record');
