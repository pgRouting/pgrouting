...
insert into test_table_l1 VALUES ('SRID=4326;linestring(5 0,10 10, 15 10)');
insert into test_table_l1 VALUES ('SRID=4326;linestring(0 0, 10 10)');
insert into test_table_l1 VALUES ('SRID=4326;linestring(10 10,10 0)');
insert into test_table_l1 VALUES ('SRID=4326;linestring(8 0, 10 10)');
