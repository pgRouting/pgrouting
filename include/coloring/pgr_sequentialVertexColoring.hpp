...
class Pgr_sequentialVertexColoring {
 public:
      ...
      */
     std::vector <Double_int64_t_rt> sequentialVertexColoring(G &graph) {
 ...
 private:
      ...
      */
     std::vector <Double_int64_t_rt> get_results(
         ...
         std::sort(results.begin(), results.end(),
             [](const Double_int64_t_rt row1, const Double_int64_t_rt row2) {
